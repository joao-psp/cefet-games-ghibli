...
vec3 toGrayscale(vec3 color) {
    float grayColor = 0.2989*color.x + 0.5870*color.y + 0.1140*color.z;
    return vec3(grayColor, grayColor, grayColor);
}

vec3 toSepia(vec3 color) {
    float sepiaR = 0.393*color.x + 0.789*color.y + 0.189*color.z;
    float sepiaG = 0.349*color.x + 0.686*color.y + 0.168*color.z;
    float sepiaB = 0.272*color.x + 0.534*color.y + 0.131*color.z;

    return vec3(sepiaR, sepiaG, sepiaB);
}
